...
- **Smaller download.** Production bundles are now minified, cutting the packaged
  extension by ~21% (2.66 → 2.10 MB) with no change in behavior. Faster to
  install and update; nothing else changes.
