...
| --- | --- |
| `images/01-live-editor.png` | The hero shot: `demo.md` open in Remarked showing the **formatting toolbar at the top** plus rendered headings/paragraphs/inline formatting. This is the first impression — make it look like a clean live document. |
...
| `images/04-toolbar-active.png` | A close-up of the **toolbar with one or more buttons lit** (active-state) — e.g. put the caret inside bold text and inside a heading so Bold / H-level buttons highlight. |
